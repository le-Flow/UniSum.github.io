...
* **Die RMI-Registry:** Ist das "Telefonbuch". Der Server (dieBank) trägt sich hier unter einem Namen ein (z.B."Sparkasse"), und die Clients suchen nach diesem Namen, um dieBank zu finden.

### Server-Seite

* `BankServer.java`: Die **Start-Klasse** (mit `main`). Siet der "Portier".
...
* `KontoZugriffsException.java` & `KontoNichtGedecktExceptionjava`:
